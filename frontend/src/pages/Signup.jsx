...
export const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 select-none font-sans">
      <div className="w-full max-w-sm bg-white border border-slate-200 rounded-3xl shadow-xl p-8 space-y-5 relative overflow-hidden">
        {loading && (
        ...
        <div className="text-center pt-2">
          <p className="text-[10px] text-slate-400 font-semibold font-manrope uppercase">
            ...
            <button
              ...
              className="text-blue-650 hover:underline font-bold ml-1 cursor-pointer"
            >
              Sign In
            </button>
          </p>
